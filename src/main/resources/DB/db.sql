...
CREATE TABLE tbl_auth(
  ...
  auth_name VARCHAR(20) UNIQUE NOT NULL COMMENT '权限名',
...
ALTER TABLE tbl_auth ADD INDEX code_flag ( auth_code, delete_flag );
...
ALTER TABLE tbl_user ADD INDEX name_code ( user_name, delete_flag );